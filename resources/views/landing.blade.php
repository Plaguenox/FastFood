@extends('layouts.app')
@section('title', 'Bienvenido a FastFood')
@section('content')
<div class="container py-5" style="background: linear-gradient(135deg, #ffefba 0%, #ff7e5f 100%); min-height: 100vh;">
    <div class="row align-items-center">
        <div class="col-md-6">
            ...
            <a href="{{ route('catalog') }}" class="btn btn-lg me-2" style="background: #ff7e5f; color: #fff; font-weight: bold; border-radius: 30px; box-shadow: 0 2px 8px #ff7e5f80;">Ver catálogo</a>
            @guest
                <a href="{{ route('register') }}" class="btn btn-lg" style="background: #ffe259; color: #d35400; font-weight: bold; border-radius: 30px; box-shadow: 0 2px 8px #ffe25980;">Regístrate</a>
            @endguest
        </div>
